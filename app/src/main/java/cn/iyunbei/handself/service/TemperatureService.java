...
public class TemperatureService extends Service {
    ...
    {
        super.onCreate();
        mContext=TemperatureService.this;
        createFloatView();
        new TemperatureUtils(this,handler).startShowNetSpeed();
    }
    @Override
...
//          LayoutParams.FLAG_NOT_TOUCHABLE
        ...
        //获取浮动窗口视图所在布局
        mFloatLayout = (LinearLayout) inflater.inflate(R.layout.temperature, null);
        ...
        mFloatView.setOnClickListener(new OnClickListener()
        {
            ...
            {
                Toast.makeText(TemperatureService.this, "onClick", Toast.LENGTH_SHORT).show();
            }
        });
    }

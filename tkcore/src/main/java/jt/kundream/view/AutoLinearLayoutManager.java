 ...
 * @Copyright： ©2017-2018
 * @author: by 杨天坤 on 2018/1/10/010 16
 * @e-mail: 245086168@qq.com
 * @desc:为了解决ScrollView嵌套RecyclerView出现的list显示不全的问题而重写的布局管理器,一般我们很少使用这样的嵌套。像云贝生活app中使用到的这种，更优雅的解决 方案就是直接使用baseAdapter项目中的添加headView 和添加footView这种方案解决
 */
...
public class AutoLinearLayoutManager extends LinearLayoutManager {
    ...
    public AutoLinearLayoutManager(RecyclerView view) {
        super(view.getContext());
        this.view = view;
        this.overScrollMode = ViewCompat.getOverScrollMode(view);
    }

    public AutoLinearLayoutManager(RecyclerView view, int orientation, boolean reverseLayout) {
